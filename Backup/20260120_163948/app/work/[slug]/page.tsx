...
type WorkConfig = {
  ...
  summaryImage?: string;
  sections: Array<{
    type: "text" | "image" | "grid" | "text-image" | "comparison" | "results" | "insights" | "process";
    title?: string;
    subtitle?: string;
    overline?: string;
    text?: string;
    ...
    image?: string;
    imageDark?: string;
    images?: Array<{ src: string; srcDark?: string; caption?: string; noBorder?: boolean }>;
    gridCols?: 2 | 3;
    beforeImage?: string;
    afterImage?: string;
    beforeLabel?: string;
    ...
    sections: [
      {
        ...
        imageRows: [
          [
            ...
            { src: "/images/porsche/Porsche_01_Overview.jpg", spanRows: true },
            { src: "/images/porsche/Porsche_05.jpg" },
          ],
          [
  ...
  vw: {
    ...
    sections: [
      ...
      },
      {
        ...
        backgroundColor: "light",
        centeredLayout: true,
        title: "Translating requirements into a validated design language",
    ...
    sections: [
      {
        ...
        images: [
          { src: "/images/vario/Vario_03.png", noBorder: false },
      ...
      },
      {
        type: "text-image",
        backgroundColor: "light",
        title: "From information overload to \nguided simplicity",
        ...
        imageRows: [
          [
            { src: "/images/vario/Vario_03.png", noBorder: false },
            { src: "/images/vario/Vario_04.png", noBorder: false },
            { src: "/images/vario/Vario_30.jpg", noBorder: false },
            { src: "/images/vario/Vario_31.jpg", noBorder: false },
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        backgroundColor: "light",
        centeredLayout: true,
        title: "Refining the user experience through continuous UX testing",
        overline: "Process",
        text: "I conducted user interviews and usability testing sessions throughout the development lifecycle. These sessions validated core assumptions about the matching mechanic and navigation. We found that users appreciated the Tinder-like swipe interface as a low-effort entry point, though some requested the ability to add stocks directly without swiping. We also stress-tested the visual depth elements to ensure legibility and system performance under changing lighting conditions.",
        images: [],
        imageRows: [
          [
      ...
      },
      {
        ...
        images: [],
        fullWidthImages: [
          { src: "/images/vario/Vario_05.png" },
          { src: "/images/vario/Vario_06.png" },
        ],
        imageRows: [
          [
      ...
      },
      {
        type: "text-image",
        backgroundColor: "light",
        title: "Strategic reprioritization \nafter successful launch",
        overline: "Outcome",
        ...
        images: [],
        fullWidthImage: "/images/vario/Vario_09.png",
      },
    ],
  },
};
...
export default function WorkPage({
  ...
  const baseBorderRadius = params.slug === 'vario' ? 32 : 16;
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-transparent pt-[80px] md:pt-[120px] lg:pt-[160px] pb-0">
        <div className="max-w-[1920px] mx-auto px-0">
          <div className="w-full px-[16px] sm:px-[40px] lg:px-[60px] 2xl:px-[100px] mb-[60px] md:mb-[80px] lg:mb-[100px] grid grid-cols-1 lg:grid-cols-3 gap-[20px] md:gap-[40px] lg:gap-[80px] items-end">
          ...
          >
            <motion.div
              className={`relative w-full bg-[var(--color-94)] ${isStackedHero ? 'overflow-visible' : 'overflow-hidden'}`}
              style={{
                ...
                borderRadius: isLargeScreen ? 20 : containerBorderRadius,
              }}
              initial={{ opacity: 0, y: 20 }}
            ...
            <style dangerouslySetInnerHTML={{
              __html: `
                .hero-image {
                  ${config.noBorder ? `
                    border-top-left-radius: ${baseBorderRadius}px;
                    border-top-right-radius: ${baseBorderRadius}px;
                    ...
                    return (
                      <React.Fragment key={index}>
                        <style dangerouslySetInnerHTML={{
                          __html: `
                            .${uniqueId} {
                              border-radius: ${Math.max(baseBorderRadius * 0.375, 6)}px;
                            ...
                            @media (min-width: 768px) {
                              .${uniqueId} {
                                border-radius: ${baseBorderRadius * 0.4375}px;
                              }
                            }
                            @media (min-width: 1024px) {
                              .${uniqueId} {
                                border-radius: ${baseBorderRadius * 0.5}px;
                              }
                            }
                            @media (min-width: 1280px) {
                              .${uniqueId} {
                                border-radius: ${baseBorderRadius * 0.5625}px;
                              }
                            }
                            @media (min-width: 1536px) {
                              .${uniqueId} {
                                border-radius: ${baseBorderRadius * 0.625}px;
                              }
                            }
                        ...
                        <motion.div
                          className={`relative overflow-hidden border-4 ${uniqueId}`}
                          style={{
      ...
      {/* Overview Section */}
      <section className={`relative bg-[var(--color-96)] ${config.noBorder ? 'pt-[60px] md:pt-[80px] lg:pt-[100px] xl:pt-[120px] 2xl:pt-[160px] pb-[60px] md:pb-[80px] lg:pb-[100px] xl:pb-[120px] 2xl:pb-[160px]' : 'py-[60px] md:py-[80px] lg:py-[100px] xl:py-[120px] 2xl:py-[160px]'}`}>
        <div className="max-w-[1920px] mx-auto px-[16px] sm:px-[40px] lg:px-[60px] 2xl:px-[100px]">
          <div className={`grid grid-cols-1 lg:grid-cols-3 gap-[40px] ${config.noBorder ? 'mb-0' : 'mb-[120px]'}`}>
            {/* Column 1-2: Summary (spans 2 columns) */}
            <motion.div
              className="flex flex-col gap-[12px] lg:col-span-2 max-w-[880px] lg:pr-[80px]"
              initial="hidden"
              whileInView="visible"
          ...
          {params.slug === 'vario' && (() => {
            ...
            return (
              <div className="flex flex-col gap-[80px] md:gap-[100px] lg:gap-[120px] mt-[60px] md:mt-[80px] lg:mt-[100px]">
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-[40px] md:gap-x-[80px] gap-y-[24px] pt-[20px]">
                  <style dangerouslySetInnerHTML={{
                    __html: `
                      .summary-row-image {
                        border-radius: ${params.slug === 'vario' ? 'clamp(6px, 1.82%, 32px)' : params.slug === 'vw' ? 'clamp(6px, 0.68%, 12px)' : 'clamp(6px, 0.91%, 16px)'};
                      }
                    `
                  }} />
                  {summaryImages.map((img, idx) => (
                    <motion.div
                      key={idx}
                      className={`summary-row-image relative overflow-hidden border-4`}
                      style={{
                        backgroundColor: 'transparent',
                        borderColor: 'var(--color-0-80)',
                        backdropFilter: 'blur(10px)',
          ...
          {/* Dynamic Grid for first section if type is "grid" */}
          {config.sections[0]?.type === "grid" && config.sections[0].imageRows && (() => {
            const firstSection = config.sections[0];
            if (!firstSection.imageRows) return null;
            // Flatten all images from all rows
            const allImages = firstSection.imageRows.flatMap((row, rowIdx) => 
            ...
            // Calculate animation order: top-left, bottom-left, middle, top-right, bottom-right
            const getAnimationDelay = (globalIdx: number) => {
              // Animation order mapping: [0, 3, 1, 2, 4] -> [top-left, bottom-left, middle, top-right, bottom-right]
              const animationOrder = [0, 3, 1, 2, 4];
              const animationIndex = animationOrder.indexOf(globalIdx);
              return animationIndex >= 0 ? animationIndex * 0.1 : globalIdx * 0.1;
            };
            
            return (
              <div 
                className="summary-grid-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[40px]"
              >
                <style dangerouslySetInnerHTML={{
                  __html: `
                    .summary-grid-image {
                ...
                {allImages.map((img, globalIdx) => (
                  <motion.div 
                    key={globalIdx}
                    className={`summary-grid-image relative overflow-hidden ${config.noBorder ? '' : 'border-responsive'} ${img.spanRows ? 'md:row-span-2' : ''}`}
                    style={{ 
                      backgroundColor: 'transparent',
                      borderColor: 'var(--color-0-80)',
                      backdropFilter: 'blur(10px)',
                    ...
                    variants={{
                      ...
                      visible: {
                        ...
                        transition: {
                          ...fadeInUpVariants.visible.transition,
                          delay: getAnimationDelay(globalIdx),
                        },
                      },
                    }}
                  >
                    <Image
                      src={img.src}
                      alt={img.caption || `Screen ${globalIdx + 1}`}
                      width={800}
                      height={600}
      ...
      {config.sections.map((section, index) => {
        // Skip grid sections that only have imageRows (displayed in summary)
        if (section.type === "grid" && !section.images) {
          return null;
        }
        ...
        return (
          <section
            key={index}
            className="relative py-[60px] md:py-[80px] lg:py-[100px] xl:py-[120px]"
                ...
                <div className="flex flex-col gap-[60px] lg:gap-[80px]">
                  {section.centeredLayout ? (
                    ...
                    <div className="flex flex-col gap-[24px]">
                      ...
                      <motion.div
                        className="flex flex-col gap-[12px] md:gap-[16px] text-center mx-auto max-w-[880px]"
                        initial="hidden"
                        whileInView="visible"
                        viewport={{ once: true, margin: "-50px" }}
                        variants={fadeInUpVariants}
                      ...
                      {section.text && (() => {
                        ...
                        return (
                          <div className={isSingleParagraph ? "max-w-[880px] mx-auto text-center" : "grid grid-cols-1 lg:grid-cols-2 gap-[40px] lg:gap-[80px]"}>
                    ...
                    (() => {
                      const isVarioWithImages = params.slug === 'vario' && section.images && section.images.length > 0;
                      
                      if (isVarioWithImages) {
                        /* Vario Layout: Text (left) + Images (right) */
                        return (
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[24px] lg:gap-[80px] items-start">
                            {/* Left: Overline + Title + Text */}
                            <motion.div
                              className="flex flex-col gap-[24px] lg:pr-[20px]"
                              initial="hidden"
                              whileInView="visible"
                              viewport={{ once: true, margin: "-50px" }}
                              variants={fadeInUpVariants}
                            ...
                            {/* Right: Images (Vario only) */}
                            <>
                              <style dangerouslySetInnerHTML={{
                                __html: `
                                  .text-image-app-screen {
                                    border-radius: ${baseBorderRadius * 0.375}px;
                                  }
                                  @media (min-width: 768px) {
                                    .text-image-app-screen {
                                      border-radius: ${baseBorderRadius * 0.4375}px;
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-[80px]">
                                {section.images.map((img, imgIndex) => (
                                  <motion.div
                                    key={imgIndex}
                                    className={`text-image-app-screen relative overflow-hidden border-4`}
                                    style={{
                                      backgroundColor: 'transparent',
                                      borderColor: 'var(--color-0-80)',
                                      backdropFilter: 'blur(10px)',
                        ...
                        return (
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[24px] lg:gap-[80px] items-start">
                            ...
                            {/* Right: Text */}
                            <div className="flex flex-col gap-[20px] md:gap-[24px] lg:pt-[48px]">
                              {section.text && section.text.split('\n\n').map((paragraph, idx) => (
                                <motion.p
                                  key={idx}
                                  className="font-sans text-[16px] md:text-[18px] lg:text-[20px] text-[var(--color-8)] font-normal tracking-[-0.24px] md:tracking-[-0.27px] lg:tracking-[-0.3px] leading-[26px] md:leading-[30px] lg:leading-[32px]"
                  ...
                  ) : section.images && section.images.length > 0 && !section.centeredLayout && !(params.slug === 'vario') && (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-[40px] lg:gap-[40px] xl:gap-[80px]">
                    <style dangerouslySetInnerHTML={{
                      __html: `
                  ...
                  {section.imageRows && !section.fullWidthImage && (() => {
                    // Flatten all images from all rows
                    ...
                    let gridClass = "grid grid-cols-1 lg:grid-cols-2 gap-[40px] lg:gap-[40px] xl:gap-[80px]";
                    
                    if (hasSpanningImage) {
                      gridClass = "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[40px]";
                    } else if (firstRowCount === 4) {
                      gridClass = hasNoBorderCards
                        ? "grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-[16px] md:gap-x-[40px] gap-y-[24px]"
                        : "grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-[40px] gap-y-[24px]";
                    }
                    ...
                    return (
                      ...
                      >
                        ...
                        {allImages.map((img, globalIdx) => {
                          ...
                          <motion.div 
                            key={globalIdx} 
                            className={`${img.noBorder ? 'flex flex-col gap-[32px] md:gap-[100px] p-[16px] md:p-[20px] bg-[var(--color-100)] rounded-[10px]' : 'flex flex-col gap-[12px] md:gap-[16px]'}`}
                          >
                            <motion.div
                              className={`row-image relative overflow-hidden ${shouldHaveBorder ? 'border-4' : ''} ${img.spanRows ? 'lg:row-span-2' : ''}`}
                          ...
                          >
                            <div 
                              className={img.noBorder ? 'bg-[var(--color-96)] rounded-[10px] p-[16px] md:p-[20px] flex items-center justify-center w-full h-[140px] md:h-[180px]' : 'w-full h-full'}
                            >
                              <div 
                    ...
                    >
                      ...
                      {section.imageRows && (() => {
                        ...
                        const gridClass = hasSpanningImage 
                          ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[60px] lg:gap-[80px]"
                          : "grid grid-cols-1 lg:grid-cols-2 gap-[60px] lg:gap-[80px]";
                        ...
                        return (
                          ...
                          >
                            <style dangerouslySetInnerHTML={{
                              __html: `
                                .row-image {
                                  border-radius: ${params.slug === 'vario' ? baseBorderRadius * 0.375 : params.slug === 'vw' ? Math.max((12 / 1760) * 320, 6) : Math.max((16 / 1760) * 320, 6)}px;
                                }
                                @media (min-width: 768px) {
                                  .row-image {
                                    border-radius: ${params.slug === 'vario' ? baseBorderRadius * 0.4375 : params.slug === 'vw' ? Math.max((12 / 1760) * 768, 6) : Math.max((16 / 1760) * 768, 6)}px;
                                  }
                                }
                                @media (min-width: 1024px) {
                                  .row-image {
                                    border-radius: ${params.slug === 'vario' ? baseBorderRadius * 0.5 : params.slug === 'vw' ? Math.max((12 / 1760) * 1024, 6) : Math.max((16 / 1760) * 1024, 6)}px;
                                  }
                                }
                                @media (min-width: 1280px) {
                                  .row-image {
                                    border-radius: ${params.slug === 'vario' ? baseBorderRadius * 0.5625 : params.slug === 'vw' ? Math.max((12 / 1760) * 1280, 6) : Math.max((16 / 1760) * 1280, 6)}px;
                                  }
                                }
                                @media (min-width: 1536px) {
                                  .row-image {
                                    border-radius: ${params.slug === 'vario' ? baseBorderRadius * 0.625 : params.slug === 'vw' ? Math.max((12 / 1760) * 1536, 6) : Math.max((16 / 1760) * 1536, 6)}px;
                                  }
                                }
                                @media (min-width: 1760px) {
                                  .row-image {
                                    border-radius: ${params.slug === 'vario' ? baseBorderRadius : params.slug === 'vw' ? 12 : 16}px;
                                  }
                                }
                              `
                            }} />
                ...
                <div className="flex flex-col">
                  {section.text ? (
                    ...
                    <div className="flex flex-col gap-[60px] lg:gap-[80px]">
                      ...
                      {/* Quotes Grid */}
                      {section.quotes && (
                        <div className="flex flex-wrap justify-center lg:justify-start gap-[16px] md:gap-[20px] w-full">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center gap-[20px]">
                      ...
                      {section.processImages.map((img, imgIndex) => (
                        <div key={imgIndex} className="contents">
                          ...
                          {imgIndex < section.processImages.length - 1 && (
                            <motion.div
      ...
      <section className="relative bg-[var(--color-96)] py-[32px] md:py-[40px]">
        <div className="max-w-[960px] mx-auto px-[16px] sm:px-[40px] lg:px-[60px] 2xl:px-[100px]">
          <div className="flex flex-col items-center gap-[24px] md:gap-[28px] lg:gap-[32px]">
            <motion.p
              className="font-sans text-[16px] md:text-[18px] lg:text-[20px] text-[var(--color-8)] font-semibold tracking-[-0.24px] md:tracking-[-0.27px] lg:tracking-[-0.3px] leading-[26px] md:leading-[30px] lg:leading-[32px] text-center"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: "-50px" }}
              variants={fadeInUpVariants}
      ...
      {/* Disclaimer Section */}
      <section className="relative bg-[var(--color-96)] pt-[60px] md:pt-[70px] lg:pt-[80px]">
        <div className="max-w-[960px] mx-auto px-[16px] sm:px-[40px] lg:px-[60px] 2xl:px-[100px]">
          <motion.p
            className="font-sans text-[11px] md:text-[12px] text-[var(--color-44)] font-normal leading-[17px] md:leading-[18px] text-center"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-50px" }}
            variants={fadeInUpVariants}
          >
            {params.slug === 'porsche' 
              ? 'The photos shown are from a project I contributed to and are presented solely for the purpose of showcasing my design and conceptual work. All photo rights are owned by Porsche AG. The use of these visuals is strictly non-commercial and intended for illustrative purposes only within this portfolio.'
              : params.slug === 'tenzir'
              ...
              : params.slug === 'vw'
              ? 'The photos shown are from a project I contributed to and are presented solely for the purpose of showcasing my design and conceptual work. All photo rights are owned by VW Group. The use of these visuals is strictly non-commercial and intended for illustrative purposes only within this portfolio.'
              : 'The photos shown are from a project I contributed to and are presented solely for the purpose of showcasing my work. All photo rights are owned by their respective owners. The use of these visuals is strictly non-commercial and intended for illustrative purposes only within this portfolio.'
            }
          </motion.p>
        </div>
      </section>
