...
// Projekt-spezifische Passwörter - nur porsche und tenzir haben ein Passwort
const getCorrectPassword = (slug: string | null): string => {
  if (slug === "porsche" || slug === "tenzir") {
    return "portfolio_26";
  }
  // Alle anderen Projekte haben kein Passwort
  return "";
};
...
export const PasswordModal: React.FC<PasswordModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const correctPassword = getCorrectPassword(slug);
