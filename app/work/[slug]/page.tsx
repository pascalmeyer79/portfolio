...
export default function WorkPage({
  ...
  const getInitialPaddingY = () => {
    if (screenSize === 'mobile') {
      ...
      if (params.slug === 'porsche' || params.slug === 'tenzir') return 32;
      return 16;
    }
    if (screenSize === 'tablet') return 24;
    ...
    <>
            ...
            >
              <style dangerouslySetInnerHTML={{
                ...
                @media (min-width: 1920px) {
                  .hero-container {
                    border-bottom-left-radius: ${params.slug === 'vario' ? 'clamp(22px, 2.5vw, 48px)' : params.slug === 'vw' ? '8px' : 'clamp(16px, 1.5vw, 16px)'};
                    border-bottom-right-radius: ${params.slug === 'vario' ? 'clamp(22px, 2.5vw, 48px)' : params.slug === 'vw' ? '8px' : 'clamp(16px, 1.5vw, 16px)'};
                  }
                }
                .hero-image {
                  border-radius: ${params.slug === 'vario' ? 'clamp(22px, 2.5vw, 48px)' : params.slug === 'vw' ? '8px' : 'clamp(16px, 1.5vw, 16px)'};
                }
              `
              }} />
              {isStackedHero ? (
                        ...
                        return (
                          <React.Fragment key={index}>
                            <style dangerouslySetInnerHTML={{
                              __html: `
                            .${uniqueId} {
                              border-radius: ${params.slug === 'vario' ? 'clamp(22px, 2.5vw, 48px)' : params.slug === 'vw' ? '12px' : 'clamp(16px, 1.5vw, 16px)'};
                          ...
                          `
                            ...
                            <motion.div
                              className={`relative overflow-hidden ${params.slug === 'vario' ? 'border-responsive' : 'border-4'} ${uniqueId}`}
                              style={{
                                backdropFilter: "blur(10px)",
                                WebkitBackdropFilter: "blur(10px)",
                                boxSizing: "border-box",
      ...
      <section className={`relative bg-[var(--color-96)] ${config.noBorder ? 'pt-[60px] md:pt-[80px] lg:pt-[140px] xl:pt-[160px] 2xl:pt-[200px] pb-[60px] md:pb-[80px] lg:pb-[100px] xl:pb-[120px] 2xl:pb-[160px]' : 'pt-[60px] md:pt-[80px] lg:pt-[140px] xl:pt-[160px] 2xl:pt-[200px] pb-[60px] md:pb-[80px] lg:pb-[100px] xl:pb-[120px] 2xl:pb-[160px]'}`}>
        <div className="max-w-[1920px] mx-auto px-[16px] sm:px-[40px] lg:px-[60px] 2xl:px-[100px]">
          <div className={`grid grid-cols-1 lg:grid-cols-3 gap-[40px] md:gap-[60px] lg:gap-[40px] 2xl:gap-[80px] ${config.noBorder ? 'mb-0' : (params.slug === 'tenzir' || params.slug === 'porsche' || params.slug === 'vario') ? 'mb-0 lg:mb-[120px]' : 'mb-[120px]'}`}>
              ...
              <div className="flex flex-col gap-[80px] md:gap-[100px] lg:gap-[120px] hidden lg:block lg:mt-[100px]">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 2xl:grid-cols-4 gap-x-[16px] md:gap-x-[40px] lg:gap-x-[40px] 2xl:gap-x-[80px] gap-y-[16px] md:gap-y-[40px] lg:gap-y-[40px] 2xl:gap-y-[80px] pt-[20px]">
                  ...
                  {summaryImages.map((img, idx) => (
                    <motion.div
                      key={idx}
                      className={`summary-row-image relative overflow-hidden ${params.slug === 'vario' ? 'border-responsive' : 'border-4'}`}
                      style={{
                        backgroundColor: 'transparent',
                        borderColor: 'var(--color-0-80)',
                        backdropFilter: 'blur(10px)',
          ...
          {config.sections && config.sections.length > 0 && config.sections[0] && params.slug === 'vw' && (() => {
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-2 gap-[16px] md:gap-[40px] lg:gap-[40px] xl:gap-[40px]">
                        {allImages.map((img, globalIdx) => {
                          ...
                          return (
                            ...
                            >
                              <motion.div
                                className={`row-image relative overflow-hidden ${shouldHaveBorder ? (params.slug === 'vario' ? 'border-responsive' : 'border-4') : ''}`}
                                style={{
                                  ...(shouldHaveBorder ? {
                                    backgroundColor: 'transparent',
                                    borderColor: 'var(--color-0-80)',
                                    backdropFilter: 'blur(10px)',
                                    WebkitBackdropFilter: 'blur(10px)',
                                    boxSizing: params.slug === 'vario' ? 'border-box' : 'content-box'
                                  } : {}),
                                  borderRadius: (params.slug as string) === 'vario' ? 'clamp(18px, 2.2vw, 44px)' : '16px'
                                }}
                              >
                                <Image
            ...
            <div className="max-w-[1920px] mx-auto px-[16px] sm:px-[40px] lg:px-[60px] 2xl:px-[100px]">
              ...
              {section.type === "grid" && section.imageRows && (() => {
                ...
                if (hasSpanningImage) {
                  ...
                  const mobileGap = params.slug === 'vario' ? '16px' : '40px';
                  gridClass = hasNoBorderCards
                    ...
                    : `grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-4 gap-x-[${mobileGap}] md:gap-x-[40px] gap-y-[${mobileGap}] md:gap-y-[40px] lg:gap-x-[40px] lg:gap-y-[40px] 2xl:gap-x-[80px] 2xl:gap-y-[80px]`;
                } else if (params.slug === 'tenzir' && section.title && section.title.includes("From data chaos")) {
                  ...
                  >
                    ...
                    {orderedImages.map(({ img, rowIdx, colIdx, actualColIdx }, globalIdx) => {
                      ...
                      return (
                        ...
                        >
                          <motion.div
                            className={`row-image relative overflow-hidden ${shouldHaveBorder ? (params.slug === 'vario' ? 'border-responsive' : 'border-4') : ''} ${img.spanRows ? 'lg:row-span-2' : ''}`}
                            ...
                            <>
                              <style dangerouslySetInnerHTML={{
                                __html: `
                                  .text-image-app-screen {
                                    border-radius: ${params.slug === 'vario' ? 'clamp(22px, 4.5vw, 48px)' : params.slug === 'vw' ? '12px' : 'clamp(16px, 1.5vw, 16px)'};
                                  }
                                `
                              }} />
                              <div className="grid grid-cols-2 md:grid-cols-2 gap-[16px] md:gap-[40px] lg:gap-[40px] 2xl:gap-[80px]">
                                {section.images?.map((img, imgIndex) => (
                                  <motion.div
                                    key={imgIndex}
                                    className={`text-image-app-screen relative overflow-hidden ${params.slug === 'vario' ? 'border-responsive' : 'border-4'}`}
                                    style={{
                                      backgroundColor: 'transparent',
                                      borderColor: 'var(--color-0-80)',
                                      backdropFilter: 'blur(10px)',
